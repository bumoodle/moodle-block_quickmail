...
$string['raisehand'] = 'Raise Your Hand';
$string['question'] = 'Your Question';
$string['qincluded'] = 'A text summary of the question will be included automatically:';
$string['raisehandsubject'] = '[{$a->courseshortname}] {$a->quizname}, Question {$a->qnum}';
$string['invalid_raisehand'] = 'Invalid question ID for the Raise Your Hand (Ask Instructor) feature.';
$string['lastresponse'] = 'Last Response:';

$string['userasks'] = '{$a->firstname} {$a->lastname} asks:';
$string['withregardtoq'] = 'with regard to question:';
$string['lastresponse'] = '{$a->firstname}\'s last response was:';
